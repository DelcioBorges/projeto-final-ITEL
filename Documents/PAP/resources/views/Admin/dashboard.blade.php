        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <h4>Quantidade total <br> de contentores</h4>
            </div>
            <div class="icon">
              <i class="ion ion-stats-bars"></i>
            </div>
             <a href="{{route('Admin.contentores.index')}}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              @if ($totEnderecos>1)
              <h4>Endereços</h4>
              @elseif($totEnderecos==1 ||$totEnderecos<1)    
                <h4>Endereço</h4>
              @endif
            ...
            <a href="{{route('Admin.enderecos.index')}}" class="small-box-footer">Ver <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
